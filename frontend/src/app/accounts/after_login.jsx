                ...
                <div className="col-md-6">
                    <div className="card bg-dark text-light border-danger shadow-lg">
                        ...
                        <ul className="list-group list-group-flush">
                               ...
                               {/*  <!-- 把這裡的 <a> 改為 collapse 觸發 --> */}
                                    <a className="text-light text-decoration-none d-flex justify-content-between align-items-center"
                                        ...
                                        <span className="d-flex align-items-center">
                                           ...
                                           {/*  <!-- <img src="path/to/avatar.jpg" alt="用戶大頭貼" className="rounded-circle me-2 fs-5" width="40" height="40"> --> */}
                                                個人檔案
                                        </span>
                            ...
                            <li className="list-group-item bg-transparent">
                                <a className="text-light text-decoration-none d-flex justify-content-between align-items-center"
                                    data-bs-toggle="collapse" href="#activeInfo" role="button" aria-expanded="false"
                                    aria-controls="activeInfo">
                            ...
                            <li className="list-group-item bg-transparent">
                                <a href="#logout" className="text-danger text-decoration-none d-block">登出</a>
                            </li>
                        </ul>
                    </div>
                </div>
